...
print('**'*20)
"""
frase =str(input('informe a frase a ser verificada:')).strip().lower()
#remove os espaços internos
separa = frase.split()
junto =''.join(separa)
...
f= str(input('Informe a frase para analise ')).strip().upper()
#removi os espaços entre as palavras
palavra = f.split()
junto=''.join(palavra)
print(junto)
#inverter a ordem da amostragem
inv =''
